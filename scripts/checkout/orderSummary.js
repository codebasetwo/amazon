...
export function renderOrderSummary(){
    ...
    cart.forEach((cartItem) => {
        ...
        let deliveryOption;
        deliveryOption = getDeliveryOption(deliveryOptionId);
    ...
    document.querySelectorAll('.js-delete-link').forEach(
        (link) => {
            link.addEventListener('click', () => {
                const productId = link.dataset.productId; // from class data atrribute.
    ...
    document.querySelectorAll('.js-delivery-option')
        .forEach((element) => {
            element.addEventListener('click', () => {
                ...
                renderOrderSummary(); // renders the page again so we can update without refreshing. MVC model view controller.
                renderPayment();
            });
        });
